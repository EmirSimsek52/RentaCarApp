...
export default function Araclar({navigation}){
    return(
           ...
           <FadeInView>
            ...
            {/*1. satır*/}
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Mercedes')}>
                <Image 
                ...
                <TouchableOpacity onPress={()=> navigation.navigate('Citroen')}>
                    <Image 
                ...
                <TouchableOpacity onPress={()=> navigation.navigate('pejo301')}>
                    <Image 
                style={{width: 145, height: 105,borderColor: 'white',borderRadius:25,margin:20
                ,}}
                source={{
